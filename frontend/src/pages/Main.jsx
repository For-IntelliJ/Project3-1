  ...
  return (<div>
      ...
      <main className="flex-grow overflow-hidden relative">
        ...
        <div className="flex justify-center items-center space-x-14 my-6 pt-10">
          {/* 첫 번째 버튼 - 지역 */}
          <div className="active:scale-95 w-[220px] h-20 bg-white hover:bg-gray-300 rounded-md flex items-center px-4 space-x-4 shadow-md hover:shadow-lg hover:scale-105 transition duration-300">
            {/* 아이콘 */}
